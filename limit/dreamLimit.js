...
// Rate limiter para obtener todos los sueños
exports.getAllDreamsLimiter = rateLimit({
    windowMs: 15 * 60 * 1000, // 15 minutos
    max: 50000000000000000000000, // Máximo 25 solicitudes por IP
...
// Rate limiter para obtener un sueño por ID
exports.getDreamByIdLimiter = rateLimit({
    windowMs: 15 * 60 * 1000, // 15 minutos
...
// Rate limiter para crear un nuevo sueño
exports.createDreamLimiter = rateLimit({
...
// Rate limiter para actualizar un sueño
exports.updateDreamLimiter = rateLimit({
    windowMs: 10 * 60 * 1000, // 10 minutos
    max: 10, // Máximo 10 solicitudes por IP
    handler: (req, res, next) => {
        const userAgent = req.get('User-Agent');
...
// Rate limiter para eliminar un sueño
exports.deleteDreamLimiter = rateLimit({
    windowMs: 10 * 60 * 1000, // 10 minutos
